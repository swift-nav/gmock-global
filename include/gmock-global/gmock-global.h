...
//
#define DECLARE_MOCK_GLOBAL_FUNC0_(tn, constness, ct, Method, ...) \
...
#define DEFINE_MOCK_GLOBAL_FUNC0_(tn, constness, ct, Method, ...) \
...
#define DECLARE_MOCK_GLOBAL_FUNC0(m, ...) DECLARE_MOCK_GLOBAL_FUNC0_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC0(m, ...) DEFINE_MOCK_GLOBAL_FUNC0_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC0(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC0(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC0(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC1_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC1_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1) constness { \
       MOCK_GLOBAL_CHECK_INIT(Method); \
...
#define DECLARE_MOCK_GLOBAL_FUNC1(m, ...) DECLARE_MOCK_GLOBAL_FUNC1_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC1(m, ...) DEFINE_MOCK_GLOBAL_FUNC1_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC1(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC1(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC1(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC2_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC2_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2) constness { \
...
#define DECLARE_MOCK_GLOBAL_FUNC2(m, ...) DECLARE_MOCK_GLOBAL_FUNC2_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC2(m, ...) DEFINE_MOCK_GLOBAL_FUNC2_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC2(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC2(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC2(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC3_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC3_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
...
#define DECLARE_MOCK_GLOBAL_FUNC3(m, ...) DECLARE_MOCK_GLOBAL_FUNC3_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC3(m, ...) DEFINE_MOCK_GLOBAL_FUNC3_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC3(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC3(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC3(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC4_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC4_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
...
#define DECLARE_MOCK_GLOBAL_FUNC4(m, ...) DECLARE_MOCK_GLOBAL_FUNC4_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC4(m, ...) DEFINE_MOCK_GLOBAL_FUNC4_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC4(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC4(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC4(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC5_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC5_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
...
#define DECLARE_MOCK_GLOBAL_FUNC5(m, ...) DECLARE_MOCK_GLOBAL_FUNC5_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC5(m, ...) DEFINE_MOCK_GLOBAL_FUNC5_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC5(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC5(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC5(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC6_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC6_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
...
#define DECLARE_MOCK_GLOBAL_FUNC6(m, ...) DECLARE_MOCK_GLOBAL_FUNC6_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC6(m, ...) DEFINE_MOCK_GLOBAL_FUNC6_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC6(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC6(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC6(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC7_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC7_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
...
#define DECLARE_MOCK_GLOBAL_FUNC7(m, ...) DECLARE_MOCK_GLOBAL_FUNC7_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC7(m, ...) DEFINE_MOCK_GLOBAL_FUNC7_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC7(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC7(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC7(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC8_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC8_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
...
#define DECLARE_MOCK_GLOBAL_FUNC8(m, ...) DECLARE_MOCK_GLOBAL_FUNC8_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC8(m, ...) DEFINE_MOCK_GLOBAL_FUNC8_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC8(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC8(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC8(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC9_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC9_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
...
#define DECLARE_MOCK_GLOBAL_FUNC9(m, ...) DECLARE_MOCK_GLOBAL_FUNC9_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC9(m, ...) DEFINE_MOCK_GLOBAL_FUNC9_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC9(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC9(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC9(m, __VA_ARGS__) \
...
//
#define DECLARE_MOCK_GLOBAL_FUNC10_(tn, constness, ct, Method, ...) \
class gmock_globalmock_##Method { \
public:\
  gmock_globalmock_##Method(const char* tag) : m_tag(tag) {}  \
  const char* const m_tag; \
...
#define DEFINE_MOCK_GLOBAL_FUNC10_(tn, constness, ct, Method, ...) \
   std::unique_ptr< gmock_globalmock_##Method > gmock_globalmock_##Method##_instance;\
   GMOCK_RESULT_(tn, __VA_ARGS__) ct Method( \
      GMOCK_ARG_(tn, 1, __VA_ARGS__) gmock_a1, \
      GMOCK_ARG_(tn, 2, __VA_ARGS__) gmock_a2, \
...
#define DECLARE_MOCK_GLOBAL_FUNC10(m, ...) DECLARE_MOCK_GLOBAL_FUNC10_(, , , m, __VA_ARGS__)
#define DEFINE_MOCK_GLOBAL_FUNC10(m, ...) DEFINE_MOCK_GLOBAL_FUNC10_(, , , m, __VA_ARGS__)

#define MOCK_GLOBAL_FUNC10(m, ...) \
  DECLARE_MOCK_GLOBAL_FUNC10(m, __VA_ARGS__) \
  DEFINE_MOCK_GLOBAL_FUNC10(m, __VA_ARGS__) \
